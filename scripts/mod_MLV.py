...
#         mlstat_659.at[ind, 'B'] = bx100_659[bx100_659.profid==profnum].B.values[0]
...
#         mlstat_660.at[ind, 'B'] = bx100_660[bx100_660.profid==profnum].B.values[0]
#         mlstat_660.at[ind, 'Bx'] = bx100_660[bx100_660.profid==profnum].Bx.values[0]
# # add the daily distance to mlstat_659
# mlstat_659['daily_dist'] = np.tile(0, len(mlstat_659))
# mlstat_659.loc[1:, 'daily_dist'] = dist_between_profiles(mlstat_659)
# mlstat_659